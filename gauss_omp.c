...
int main(int argc, char** argv) {
	...
	*/
	...
	char* outputfilename = "outputOMP.bmp";
	printf("inputfile = ");
...
#pragma omp parallel for collapse(2) default(none) shared(Size, i, j,texels ,GAUSS21,width) private(k, l, index) reduction(+:rsume,gsume,bsume) num_threads(threadsnum)
